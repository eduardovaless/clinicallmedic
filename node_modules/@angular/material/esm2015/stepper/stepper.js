...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener() { const step_r141 = ctx.$implicit; return step_r141.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r147); const ctx_r146 = ɵngcc0.ɵɵnextContext(); return ctx_r146._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵtemplate(2, MatHorizontalStepper_ng_container_1_div_2_Template, 1, 0, "div", 5);
    ɵngcc0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const step_r141 = ctx.$implicit;
    const i_r142 = ctx.index;
    const isLast_r143 = ctx.last;
    const ctx_r139 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r139._getFocusIndex() === i_r142 ? 0 : 0 - 1)("id", ctx_r139._getStepLabelId(i_r142))("index", i_r142)("state", ctx_r139._getIndicatorType(i_r142, step_r141.state))("label", step_r141.stepLabel || step_r141.label)("selected", ctx_r139.selectedIndex === i_r142)("active", step_r141.completed || ctx_r139.selectedIndex === i_r142 || !ctx_r139.linear)("optional", step_r141.optional)("errorMessage", step_r141.errorMessage)("iconOverrides", ctx_r139._iconOverrides)("disableRipple", ctx_r139.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r142 + 1)("aria-setsize", ctx_r139.steps.length)("aria-controls", ctx_r139._getStepContentId(i_r142))("aria-selected", ctx_r139.selectedIndex == i_r142)("aria-label", step_r141.ariaLabel || null)("aria-labelledby", !step_r141.ariaLabel && step_r141.ariaLabelledby ? step_r141.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !isLast_r143);
} }
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r151 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r151); const ctx_r150 = ɵngcc0.ɵɵnextContext(); return ctx_r150._animationDone.next($event); });
    ...
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r140._getAnimationDirection(i_r149))("id", ctx_r140._getStepContentId(i_r149));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r140.selectedIndex === i_r149 ? 0 : null)("aria-labelledby", ctx_r140._getStepLabelId(i_r149))("aria-expanded", ctx_r140.selectedIndex === i_r149);
    ɵngcc0.ɵɵadvance(1);
...
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatVerticalStepper_div_0_Template_mat_step_header_click_1_listener() { const step_r153 = ctx.$implicit; return step_r153.select(); })("keydown", function MatVerticalStepper_div_0_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r158); const ctx_r157 = ɵngcc0.ɵɵnextContext(); return ctx_r157._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵelementStart(3, "div", 4);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r158); const ctx_r159 = ɵngcc0.ɵɵnextContext(); return ctx_r159._animationDone.next($event); });
    ...
    const step_r153 = ctx.$implicit;
    const i_r154 = ctx.index;
    const isLast_r155 = ctx.last;
    const ctx_r152 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r152._getFocusIndex() == i_r154 ? 0 : 0 - 1)("id", ctx_r152._getStepLabelId(i_r154))("index", i_r154)("state", ctx_r152._getIndicatorType(i_r154, step_r153.state))("label", step_r153.stepLabel || step_r153.label)("selected", ctx_r152.selectedIndex === i_r154)("active", step_r153.completed || ctx_r152.selectedIndex === i_r154 || !ctx_r152.linear)("optional", step_r153.optional)("errorMessage", step_r153.errorMessage)("iconOverrides", ctx_r152._iconOverrides)("disableRipple", ctx_r152.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r154 + 1)("aria-setsize", ctx_r152.steps.length)("aria-controls", ctx_r152._getStepContentId(i_r154))("aria-selected", ctx_r152.selectedIndex === i_r154)("aria-label", step_r153.ariaLabel || null)("aria-labelledby", !step_r153.ariaLabel && step_r153.ariaLabelledby ? step_r153.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-stepper-vertical-line", !isLast_r155);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r152._getAnimationDirection(i_r154))("id", ctx_r152._getStepContentId(i_r154));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r152.selectedIndex === i_r154 ? 0 : null)("aria-labelledby", ctx_r152._getStepLabelId(i_r154))("aria-expanded", ctx_r152.selectedIndex === i_r154);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r153.content);
} }
